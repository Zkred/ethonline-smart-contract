...
interface IAgentRegistry {
    ...
    error ServiceEndpointAlreadyRegistered();
    error ServiceEndpointAlreadyRegisteredByAnotherAgent();
    error AgentNotFound();
    error AgentNotFoundForEndpoint();
    error RequestExpired();
    error InvalidNonce();
    error InvalidSignature();
    error DIDAddressMismatch();
    error InvalidDIDValidatorAddress();
    ...
    /// @notice Get agent details by service endpoint
